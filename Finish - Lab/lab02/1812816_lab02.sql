...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`1812816_Database_Lab02` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `1812816_Database_Lab02`;
...
from customers as A, payments as B
...
select * from orders where date(shippedDate)='2003/1/18';

select * from orders where month(requiredDate)='5' and year(requiredDate)='2005' and status='Shipped';

select * from products where productLine ='Classic Cars';

select lastName, officeCode, jobTitle from employees;
